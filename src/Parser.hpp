  ...
  public:
    ...
    bool parseGetnPost() {
        try {
            ...
            parse_pathname();
            parsed_message->url =
                parsed_message->hostname + parsed_message->pathname;
  ...
  public:
    ...
    void parseMaxAge() {
        ...
        if (start == std::string::npos) {
            ...
            std::string tempMaxAge =
                responseMessage.substr(start, finish - start);
    ...
    void parseETag() {
        ...
        if (start == std::string::npos + 7) {
            ...
            size_t finish = responseMessage.find("\n", start);
            responseParsed->Etag =
                responseMessage.substr(start, finish - start - 2);
        }
